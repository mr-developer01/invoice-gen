...
const MyDocument = () => (
  <Document>
    <Page style={styles.body}>
      ...
      <Image
        style={styles.image}
        src="https://images.unsplash.com/photo-1610621062045-ef5f7201bb3f?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YmxhY2slMjBhbmQlMjB3aGl0ZSUyMHBob3RvZ3JhcGh5fGVufDB8fDB8fHww"
      />
